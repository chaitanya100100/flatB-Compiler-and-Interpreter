...
// all statements
//
void Traverse::visit(AST_expression_statement * expression_statement)
{
    cout << "expression_statement" << endl;
    expression_statement->expression->accept(*this);
}

void Traverse::visit(AST_assignment_statement * assignment_statement)
{
    cout << "assignment_statement" << endl;
    assignment_statement->expression->accept(*this);
}

void Traverse::visit(AST_block_statement * block_statement)
{
...
void Traverse::visit(AST_if_statement * if_statement)
{
...
void Traverse::visit(AST_ifelse_statement * ifelse_statement)
{
...
void Traverse::visit(AST_for_statement * for_statement)
{
...
void Traverse::visit(AST_while_statement * while_statement)
{
...
void Traverse::visit(AST_goto_statement * goto_statement)
{
    cout << "goto_statement : " << goto_statement->label << endl;
    goto_statement->condition->accept(*this);
}

void Traverse::visit(AST_read_statement * read_statement)
{
    cout << "read_statement" << endl;
}

void Traverse::visit(AST_print_statement * print_statement)
{
    cout << "print_statement" << endl;
}

void Traverse::visit(AST_label_statement * label_statement)
{
...
// all expressions
//
void Traverse::visit(AST_binary_operator_expression * binary_operator_expression)
{
...
void Traverse::visit(AST_unary_operator_expression * unary_operator_expression)
{
...
//
void Traverse::visit(AST_variable_single_int * variable_single_int)
{
    cout << "variable_single_int : " << variable_single_int->variable_name << endl;
}

void Traverse::visit(AST_variable_array_int * variable_array_int)
{
...
void Traverse::visit(AST_int_literal * int_literal)
{
    cout << "int_literal : " << int_literal->int_literal << endl;
}

void Traverse::visit(AST_string_literal * string_literal)
{
